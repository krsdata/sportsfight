...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic Admin Theme #4 | eCharts</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Preview page of Metronic Admin Theme #4 for echart demos" name="description" />
                        ...
                        <div class="col-md-12">
                            <div class="portlet light portlet-fit bordered">
                                ...
                                <div class="portlet-body">
                                    <div id="echarts_bar" style="height:300px; width: 200px"></div>
                                </div>
                            </div>
                        </div>
                    </div>
